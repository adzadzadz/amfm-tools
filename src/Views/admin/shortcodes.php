                ...
                <div class="amfm-header-actions">
                    <div class="amfm-header-stats">
                        <div class="amfm-header-stat">
                            <span class="amfm-header-stat-number"><?php echo count($excluded_keywords); ?></span>
                            <span class="amfm-header-stat-label">Excluded</span>
                        </div>
                        <div class="amfm-header-stat">
                            <span class="amfm-header-stat-number">1</span>
                            <span class="amfm-header-stat-label">Shortcodes</span>
                        </div>
                    </div>
